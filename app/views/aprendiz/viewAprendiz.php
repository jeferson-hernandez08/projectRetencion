<div class="data-container">
    <div class="navegate-group">
        ...
        <div class="create">
            <a href="/aprendiz/new">
            <button>
                <i class="fa fa-plus-circle"></i> <p>Crear aprendiz</p>
            </button>
            </a>
        </div>
        <div>
    ...
    <div id="modal-importar" class="modal" style="display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Importar Aprendices desde Excel</h3>
            ...
            <?php foreach ($aprendices as $value): ?>
                <div class="report-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="report-info">
                            <div class="info-label"><i class="fas fa-calendar-alt"></i> Email:</div>
                            <?php echo (!empty($value->email)) ? htmlspecialchars($value->email) : 'No asignado'; ?>
                        </div>
                    </div>
