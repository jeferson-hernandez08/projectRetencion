    ...
    <div class="info">
        <form action="/usuario/update" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $usuario->firstName ?>" name="txtNombres" id="txtNombres" class="form-control" required>
            </div>

            <!-- Campo Apellidos del usuario -->
            <div class="form-group">
                <label for="txtApellidos"><i class="fas fa-user-tag"></i> Apellidos del usuario</label>
                <input type="text" value="<?php echo $usuario->lastName ?>" name="txtApellidos" id="txtApellidos" class="form-control">
            </div>

            <!-- Campo Documento del usuario -->
            <div class="form-group">
                <label for="txtDocumento"><i class="fas fa-id-badge"></i> Documento del usuario</label>
                <input type="text" value="<?php echo $usuario->document ?>" name="txtDocumento" id="txtDocumento" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $usuario->phone ?>" name="txtTelefono" id="txtTelefono" class="form-control" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="txtTipoCoordinador" id="txtTipoCoordinador" class="form-control" required>
                    <option value="No es coordinador" <?php echo ($usuario->coordinadorType == 'No es coordinador') ? 'selected' : '' ?>>No es coordinador</option>
                    <option value="Coordinador académico" <?php echo ($usuario->coordinadorType == 'Coordinador académico') ? 'selected' : '' ?>>Coordinador académico</option>
                    <option value="Coordinador de formación" <?php echo ($usuario->coordinadorType == 'Coordinador de formación') ? 'selected' : '' ?>>Coordinador de formación</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="txtGestor" id="txtGestor" class="form-control" required>
                    <option value="0" <?php echo ($usuario->manager == 0) ? 'selected' : '' ?>>No</option>
                    <option value="1" <?php echo ($usuario->manager == 1) ? 'selected' : '' ?>>Sí</option>
                </select>
            </div>
